...
1000.times do
  adhaar_number = Faker::Number.unique.number(digits: 12).to_s
...
User.create(username:"hatim",email:"htimdady31i@gmail.com",password:"Hornet@31", password_confirmation:"Hornet@3
1",role:"admin")
